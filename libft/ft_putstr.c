...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/05/21 14:16:02 by ksilekwa          #+#    #+#             */
/*   Updated: 2019/06/05 17:01:42 by ksilekwa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**	ft_putstr("string\n");
**	ft_putstr("\033[36mTest 2: input \"ksilekwa@student.
**	wethinkcode.co.za\"\n\033[0m");
**	ft_putstr("ksilekwa@student.wethinkcode.co.za\n");
